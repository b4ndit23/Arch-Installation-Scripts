...
# Packages
install_packages aircrack-ng navi ipcalc exiftool hydra checksec net-snmp finalrecon qflipper-bin nmap openbsd-netcat rlwrap mariadb john feroxbuster impacket metasploit exploitdb proxychains-ng oath-toolkit bind sqlmap wpscan sherlock sqlite chromium tftp-hpa zaproxy hashcat nasm strace
...
# Yay Packages
install_packages_yay ffuf gobuster burpsuite smbmap naabu netexec ruby-evil-winrm whatweb steghide pince git-dumper-git caido-desktop rustscan hashid python-oletools detect-it-easy
