...
# Utils
install_packages curlie waybar yazi ueberzugpp fzf btop cliphist pam_yubico pam-u2f atool unzip zip sxiv 7zip net-tools openvpn proton-vpn-gtk-app jq timeshift qemu-user perl-image-exiftool firejail docker-compose dosfstools macchanger
